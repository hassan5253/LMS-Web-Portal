<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeFile="frm_Assignments_Admin.aspx.cs" Inherits="Admin_frm_Assignments_Admin" %>
                    ...
                    <ContentTemplate>
                        <div class="module-option clearfix">
                            <div class="input-append pull-left">
                                <ajax:CalendarExtender ID="Calenderextender" PopupPosition="TopRight" 
                                ...
                                <asp:TextBox class="span6" runat="server" placeholder="Enter Keywords" ID="txt_DateSearch"
