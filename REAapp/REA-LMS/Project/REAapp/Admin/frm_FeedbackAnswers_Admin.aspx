<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeFile="frm_FeedbackAnswers_Admin.aspx.cs" Inherits="Admin_frm_FeedbackAnswers_Admin" %>
        ...
        <div class="module-body">
            <div class="stream-composer media">
                ...
                <strong>
                    ...
                    <div class="clearfix">
                        <asp:Button ID="btn_Save" runat="server" CssClass="btn btn-success pull-right" 
                            Text="Answer" onclick="btn_Save_Click" />
                    </div>
                </div>
            </div>
            <!--/.stream-list-->
