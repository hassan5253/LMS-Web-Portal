<%@ Page Title="" Language="C#" MasterPageFile="~/Staff/Staff.master" AutoEventWireup="true"
    CodeFile="frm_AssignmentMarks_Staff.aspx.cs" Inherits="Staff_frm_AssignmentMarks_Staff" %>
        ...
        <div class="module-body">
            <div class="module-option clearfix">
                <div class="input-append pull-left">
                    ...
                    <asp:LinkButton ID="lnkbtn_Search" runat="server" class="btn" Text='<i class="icon-search"></i>'></asp:LinkButton>
                </div>
...
<%--            <form class="form-horizontal row-fluid">--%>
            <div class="control-group">
                ...
                <div class="controls">
                    <asp:TextBox ID="txt_StdRollNo" runat="server" ReadOnly="true" CssClass="span6"></asp:TextBox>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <asp:TextBox ID="txt_AssName" ReadOnly="true" runat="server" CssClass="span6" ></asp:TextBox>
            ...
            <div class="control-group">
                <div class="controls">
                    <asp:Button ID="btn_Save" runat="server" CssClass="btn btn-large btn-primary" Text="Save"
