<%@ Page Title="" Language="C#" MasterPageFile="~/Staff/Staff.master" AutoEventWireup="true"
    CodeFile="frm_Home_Staff.aspx.cs" Inherits="Staff_frm_Home_Staff" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent_Staff" runat="Server">
<div class="btn-controls">
        <div class="btn-box-row row-fluid">
            <a href="frm_AssignmentsMarks_Staff.aspx" class="btn-box big span4"><i class=" icon-paste"></i><b>Assignment's Marks</b>
                <p class="text-muted">
                    Assignments & Marks</p>
            </a><a href="frm_AssignmentCreate_Staff.aspx" class="btn-box big span4"><i class="icon-book"></i><b>Upload Assignment</b>
                <p class="text-muted">
                   Create New Assignment</p>
            </a><a href="frm_Feedback_Staff.aspx" class="btn-box big span4"><i class="icon-money"></i><b>Answer the queries </b>
                <p class="text-muted">
                    Feedback & Queries</p>
            </a>
        </div>
