...
using System.Data;
using READBModel;
public partial class Students_frm_Feedback_Std : System.Web.UI.Page
{
    ...
    protected void lnkBtn_Answer_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            using (READBEntities cntx = new READBEntities())
            {
                ...
                Response.Redirect("frm_FeedbackAnswers_Admin.aspx?q_pid=" + ID);
            }
    ...
    public void BindItems()
    {
        ...
        using (READBEntities cntx = new READBEntities())
        {
            ...
            obj = (from q in cntx.tblQueries
                   ...
                   where q.q_parent_id == 0 orderby q.q_id descending
